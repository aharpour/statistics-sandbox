...
class BernoulliDistributionSignificanceCalculatorHoeffdingTest {

    private final SignificanceCalculator calculator = new BernoulliDistributionSignificanceCalculatorHoeffding();
